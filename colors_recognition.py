...
from IPython.display import clear_output            # function to clear the terminal
...
try:
    ...
    print(f'CV2 version: {cam.cv2.__version__}')    # print to terminal the cv2 version
    print()
except:
    pass
...
def read_facelets():
    ...
    cv2.putText(frame, str('ESC to escape'), (400, int(h-12)), font, fontScale*1.2,fontColor,lineType)
...
def plot_colors(BGR_mean, edge, frame, font, fontScale, lineType):
    ...
    y_start=int(edge*16.5)   # top lef corner of the rectangle where all the cube's faces are plot
